...
Consideremos dos grafos arbitrarios y evaluemos si son isomorfos
...
```
En estructuras mas complejas resulta conveniente contar con alguna herramienta de evaluación de isomofismo, lo que nos proporciona la función *isomorphic()*
```{r}
